...
public class GenealogyRequestReviewTest {
    ...
    /**
     * Testing startReview().
     * Should fail since "InProgress" != "BeginningReview"
     */
    @Test
    public void testStartReview() {
        ...
        assertEquals("Beginning review...", review.getReviewStatus());  
    ...
    /**
     * Testing editData().
     * Should fail since "Updated Form" != "Editing".
     */
    @Test
    public void testEditData() {
        ...
        Form form2 = new Form(2, "Updated Form", "Description");
    ...
    public void testValidateData() {
        ...
        assertNotEquals(true, review.validateData());  
    ...
    public void testNeedCorrections() {
        ...
        assertNotEquals("Returned", review.getReviewStatus());  
    ...
    public void testFinalizeReview() {
        ...
        assertNotEquals("Reviewed", review.getReviewStatus());  
